...
namespace cs.min2phase
{
    class CoordCube
    {
        static  int N_MOVES = 18;
        static  int N_MOVES2 = 10;

        static  int N_SLICE = 495;
        ...
        static  int P2_PARITY_MOVE = Search.USE_COMBP_PRUN ? 0xA5 : 0;
        ...
        public static char[][] TwistMove = new char[N_TWIST_SYM][];
        public static char[][] FlipMove = new char[N_FLIP_SYM][];
        public static char[][] UDSliceConj = new char[N_SLICE][];
        ...
        //phase2
        public static char[][] CPermMove = new char[N_PERM_SYM][];
        public static char[][] EPermMove = new char[N_PERM_SYM][];
        public static char[][] MPermMove = new char[N_MPERM][];
        public static char[][] MPermConj = new char[N_MPERM][];
        static char[][] CCombPMove;// = new char[N_COMB][N_MOVES2];
        public static char[][] CCombPConj = new char[N_COMB][];
        ...
        static CoordCube()
        {
            ...
            for (int i = 0; i < N_SLICE; i++)
            {
                ...
                UDSliceConj[i] = new char[8];
            }
            for (int i = 0; i < N_TWIST_SYM; i++)
            {
                TwistMove[i] = new char[N_MOVES];
            }
            for (int i = 0; i < N_FLIP_SYM; i++)
            {
                FlipMove[i] = new char[N_MOVES];
            }
            for (int i = 0; i < N_PERM_SYM; i++)
            {
                CPermMove[i] = new char[N_MOVES2];
                EPermMove[i] = new char[N_MOVES2];
            }
            for (int i = 0; i < N_MPERM; i++)
            {
                MPermMove[i] = new char[N_MOVES2];
                MPermConj[i] = new char[16];
            }
            for (int i = 0; i < N_COMB; i++)
            {
                CCombPConj[i] = new char[16];
            }
        }
        ...
        static void initCombPMoveConj()
        {
            CubieCube c = new CubieCube();
            CubieCube d = new CubieCube();
            CCombPMove = new char[N_COMB][];
            //CCombPMove = new char[N_COMB][N_MOVES2];
            for (int i = 0; i < N_COMB; i++)
            {
                CCombPMove[i] = new char[N_MOVES2];
            }
            for (int i = 0; i < N_COMB; i++)
            {
                c.setCComb(i % 70);
        ...
        static void initTwistFlipPrun(bool fullInit)
        {
            initRawSymPrun(
                TwistFlipPrun,
                null, null,
        ...
        static void initSliceTwistPrun(bool fullInit)
        {
            initRawSymPrun(
                UDSliceTwistPrun,
        ...
        static void initSliceFlipPrun(bool fullInit)
        {
            initRawSymPrun(
                UDSliceFlipPrun,
                UDSliceMove, UDSliceConj,
        ...
        static void initMCPermPrun(bool fullInit)
        {
            initRawSymPrun(
                MCPermPrun,
                MPermMove, MPermConj,
        ...
        static void initPermCombPPrun(bool fullInit)
        {
            initRawSymPrun(
                EPermCCombPPrun,
