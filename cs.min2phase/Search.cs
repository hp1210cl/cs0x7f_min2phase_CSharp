...
namespace cs.min2phase
{
    ...
    public class Search
    {
        ...
        static  int MAX_PRE_MOVES = 20;
        static  bool TRY_INVERSE = true;
        static  bool TRY_THREE_AXES = true;
        ...
        private Util.Solution solution;
         ...
         */
        public  string  getsolution( string  facelets, int maxDepth, long probeMax, long probeMin, int verbose)
        {
        ...
        public int verify( string  facelets)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 54; i++)
                {
                    ...
                    //    return -1;
                    //}
                    if (center.IndexOf(facelets[i]) == -1)
                    {
                        return -1;
                    }
                    else
